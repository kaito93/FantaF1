...
namespace FantaF1DataAccessDB
{
    ...
    public partial class RegoleCampionatoMondiale
    {
        ...
        public int PunteggioQuartoSprintRace { get; set; }
        public int PunteggioQuintoSprintRace { get; set; }
        public int PunteggioSestoSprintRace { get; set; }
        public int PunteggioSettimoSprintRace { get; set; }
        public int PunteggioOttavoSprintRace { get; set; }
