...
namespace FantaF1DataAccessDB
{
    ...
    public partial class RisultatoGaraReale
    {
        ...
        public Nullable<int> PilotaId04SprintRace { get; set; }
        public Nullable<int> PilotaId05SprintRace { get; set; }
        public Nullable<int> PilotaId06SprintRace { get; set; }
        public Nullable<int> PilotaId07SprintRace { get; set; }
        public Nullable<int> PilotaId08SprintRace { get; set; }
